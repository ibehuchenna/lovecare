...
import CareReceiverForm from './CareRecieverForm';
import MonetizationOnIcon from '@mui/icons-material/MonetizationOn'; // Add this line for the icon
...
>
  ...
  {open && (
    ...
    />
        ...
        >
          <Toolbar />
          <Box sx={{ width: '600px', display: 'flex', justifyContent: 'center', gap: '20px', flexWrap: 'wrap',marginLeft:'40px',marginTop:'30px' }}>
           <CareReceiverForm/>
            </Box>
        </Box>
